...
import com.example.aggienetwork.Adapter.UserlistAdapter;
    ...
    private void getfriendlist() {
        FirebaseDatabase.getInstance().getReference().child("Follow").child(firebaseUser.getUid()).child("Following").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                friendlist.clear();
                FirebaseDatabase.getInstance("https://aggienet-users.firebaseio.com/").getReference().child("Users").addValueEventListener(new ValueEventListener() {
                    @Override
