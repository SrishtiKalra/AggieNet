...
import com.example.aggienetwork.Adapter.CommentAdapter;
import com.example.aggienetwork.Model.Comment;
...
public class CommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance("https://aggienet-users.firebaseio.com/").getReference().child("Users").child(firebaseUser.getUid())
    ...
    private void getimage(String uid){
        FirebaseDatabase.getInstance("https://aggienet-users.firebaseio.com/").getReference().child("Users").child(uid).child("image").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void image(String imageUrl) {
        ...
        FirebaseDatabase.getInstance().getReference().child("Comments").child(Postid).child(firebaseUser.getUid()).setValue(map).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(CommentActivity.this, "Commented Successfully", Toast.LENGTH_LONG).show();
                finish();
            }
