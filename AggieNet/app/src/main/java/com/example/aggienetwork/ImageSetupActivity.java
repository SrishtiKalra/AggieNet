...
//            }
                    Uri imageUri = result.getData().getData();
                    Log.i("Imageuri exists", String.valueOf(imageUri));
                    ...
                    Log.i("Imageref exists", String.valueOf(imageRef));
                    ...
                    imageRef.putFile(imageUri)
                            .addOnSuccessListener(taskSnapshot -> {
                                ...
                                imageRef.getDownloadUrl().addOnSuccessListener(uri -> {
                                    ...
                                    DatabaseReference newUserDbRef = FirebaseDatabase.getInstance("https://aggienet-users.firebaseio.com/")
                                            .getReference()
                                            .child("Users")
                                            .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                                            .child("image");

                                    newUserDbRef.setValue(uri.toString());
                                });
                                startActivity(new Intent(ImageSetupActivity.this, MainActivity.class));
                            })
                            .addOnFailureListener(e -> {
                                Log.e("ImageUpload", "Uploadfailed", e);
                            });
                }
            }
        });
