    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Log.i("snapshot value", String.valueOf(snapshot));
                Log.i("snapshotchildvalue", String.valueOf(snapshot.child(user.getId())));
                Log.i("snapshotchildvalueexists", String.valueOf(snapshot.child(user.getId()).exists()));

                Log.i("here adapter", "here adapter");
                if(user.getId() != null){
                    Log.i("user", "user");
                }
