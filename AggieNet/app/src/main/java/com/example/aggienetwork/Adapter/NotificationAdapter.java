...
import com.example.aggienetwork.Model.Notification;
...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.ViewHolder>{
    ...
    private void getText(Notification notifications, TextView notifcationtext, String userid, String text) {
        FirebaseDatabase.getInstance("https://aggienet-users.firebaseio.com/").getReference().child("Users").child(userid).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void getimage(CircleImageView notificationimage, ImageView postimage, String userid, String postid) {
        ...
        FirebaseDatabase.getInstance("https://aggienet-posts.firebaseio.com/").getReference().child("Posts").child(postid).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Log.i("postsnapshot", String.valueOf(snapshot));
        ...
        //For UserImage
        DatabaseReference reference = FirebaseDatabase.getInstance("https://aggienet-users.firebaseio.com/").getReference().child("Users").child(userid);
