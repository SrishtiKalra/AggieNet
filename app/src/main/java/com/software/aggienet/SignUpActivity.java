...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void registerUser(String emaill, final String pass, final String uname) {
        ...
        mAuth.createUserWithEmailAndPassword(emaill, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            //cremoved nonNull in below method param
            @Override
            public void onComplete(Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(SignUpActivity.this, "Welcome " + user.getDisplayName() + " ! Engage, interact, and make an impact. Happy connecting!", Toast.LENGTH_LONG).show();
